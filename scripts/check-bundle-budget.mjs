...
import {
  ...
  WEEK_SIX_RECORDS_COLD_LOAD_MAX_BYTES,
  PYTHON_RUNTIME_TRANSFER_MAX_BYTES,
} from './budget-limits.mjs';
export { WEEK_THREE_CUILAN_COLD_LOAD_MAX_BYTES, WEEK_THREE_BAJIE_JOINING_COLD_LOAD_MAX_BYTES, WEEK_THREE_BOSS_COLD_LOAD_MAX_BYTES, WEEK_THREE_YUNZHAN_DIALOGUE_COLD_LOAD_MAX_BYTES, WEEK_THREE_MANOR_HELP_COLD_LOAD_MAX_BYTES, WEEK_FOUR_MAPPING_COLD_LOAD_MAX_BYTES, WEEK_FOUR_VARIABLE_COLD_LOAD_MAX_BYTES, WEEK_SIX_RECORDS_COLD_LOAD_MAX_BYTES, PYTHON_RUNTIME_TRANSFER_MAX_BYTES };
...
const COLD_LOAD_ROUTE_STATIC_ISOLATION = Object.freeze({
  ...
  'src/components/WeekSixRecordsExperience.tsx': [
...
async function main() {
  ...
  const branchWorkerFiles = distFiles.filter((file) => /^assets\/(?:weekFour(?:Branch|List|Boss)|weekFive(?:Monks|Function|Weather|Decomposition|StoryOrchestration)|weekSixRecords)Python\.worker-[A-Za-z0-9_-]+\.js$/.test(file));

...
describe('course manifest', () => {
  ...
  it('promotes week two and W3-M1 through M5 without legacy fallback', () => {
    ...
    const formalIds = new Set(['w1-m1', 'w1-m2', 'w1-m3', 'w1-m4', 'w1-m5', 'w2-m1', 'w2-m2', 'w2-m3', 'w2-m4', 'w2-m5', 'w3-m1', 'w3-m2', 'w3-m3', 'w3-m4', 'w3-m5', 'w4-m1', 'w4-m2', 'w4-m3', 'w4-m4', 'w4-m5', 'w5-m1', 'w5-m2', 'w5-m3', 'w5-m4', 'w5-m5', 'w6-m1']);

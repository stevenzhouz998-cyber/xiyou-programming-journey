...
import type { WeekFiveMonksAccess } from '../progress/progress';

export function WeekFiveMonksAccessNotice({ access }: { access: WeekFiveMonksAccess }) {
  ...
  return (
    <main className="not-found week-four-branch-access-notice">
      ...
      <Link to="/mission/w4-m5">返回上一关继续验证</Link>
    </main>
  );
}

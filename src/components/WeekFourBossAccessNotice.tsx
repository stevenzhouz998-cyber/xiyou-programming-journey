...
import type { WeekFourBossAccess } from '../progress/progress';

export function WeekFourBossAccessNotice({ access }: { access: WeekFourBossAccess }) {
    ...
    <main className="not-found week-four-branch-access-notice">
      ...
      <p>
        {historical
          ...
          : '完成上一关的核验后，就能继续白虎岭总试炼。'}
      </p>
      <Link to="/mission/w4-m4">返回上一关继续验证</Link>
    </main>
  );
}

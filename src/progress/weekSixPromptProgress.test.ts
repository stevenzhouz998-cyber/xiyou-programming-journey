...
describe('W6-M3 formal prompt progress',()=>{
  it('binds source, session, run and work while preserving M2 and unlocking M4',()=>{
    ...
    expect(completed).toMatchObject({schemaRevision:21,missions:{'w6-m3':{status:'completed'}},missionCompletionEvidence:{'w6-m3':{kind:'formal-v3',sourceWorkId:source.workId,workId:'w6-m3-second-attempt-brief'}}});

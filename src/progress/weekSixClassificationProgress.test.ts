...
describe('W6-M2 formal progress', () => {
  it('binds the successful classification to M1 work, preserves predecessors, and unlocks M3 once', () => {
    ...
    expect(completed).toMatchObject({ schemaRevision: 21, missions: { 'w6-m2': { status: 'completed' } }, missionCompletionEvidence: { 'w6-m2': { kind: 'formal-v3', sourceWorkId: source.workId, workId: 'w6-m2-fan-evidence-classification' } } });

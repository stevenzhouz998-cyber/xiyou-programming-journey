...
| assets/week-four-mapping/white-tiger-ridge-background.webp | be1e3a53a62a22f9154f385b548c37e446e1f6a4e1f946dab87332483809e266 | Bright, child-safe White Tiger Ridge entrance background for the Blockly-to-Python mapping stage | OpenAI built-in image_gen | [Prompt W4M1-001](#prompt-w4m1-001-white-tiger-ridge-background) | 1280x720 | generated in-project with built-in image_gen; provenance verified | w4-m1 WeekFourMappingScene; w4-m2 WeekFourVariableEvidenceScene; w4-m3 WeekFourBranchScene; w4-m4 WeekFourListScene; w4-m5 WeekFourBossScene | visual-qa-passed |
...
| assets/week-five-weather/rain-altar-background.webp | b5de6f6905000d6f92dfdaa693d62e6fe9f52538b960c8fe118b132cbcc87d02 | Chechi rain-prayer altar story setting, independent of parameter execution | OpenAI built-in image_gen | [Prompt W5M3-001](#prompt-w5m3-001-rain-altar) | 1536x1024 | generated in-project with built-in image_gen; provenance verified | w5-m3 WeekFiveWeatherScene | visual-qa-passed |
| assets/week-five-trials/contest-courtyard-background.webp | 46c5d825c9f49883f9af25ed65ec6b5b8f3eaf307977d2094388ab4bab37e203 | Chechi educational story-recording pavilion, independent of function execution | OpenAI built-in image_gen | [Prompt W5M4-001](#prompt-w5m4-001-contest-courtyard) | 1536x1024 | generated in-project with built-in image_gen; provenance verified | w5-m4 WeekFiveDecompositionScene; w5-m5 WeekFiveStoryOrchestrationScene | visual-qa-passed |
| assets/week-six-records/flaming-mountain-background.webp | 85c40c368dc7ab61ec5abe56fcf082ddccbc81923ecfe907ae7a5d99825deadc | Child-safe Flaming Mountains learning pavilion, static story setting independent of executed records | OpenAI built-in image_gen | [Prompt W6M1-001](#prompt-w6m1-001-flaming-mountain-background) | 1536x1024 | generated in-project with built-in image_gen; provenance verified | w6-m1 WeekSixRecordsScene; w6-m2 WeekSixClassificationScene; w6-m3 WeekSixPromptScene; w6-m4 WeekSixFactCheckScene; w6-m5 WeekSixArchiveScene | visual-qa-passed |
...
### Prompt W3M4-001 bajie joining background

```text
Use case: illustration-story
Asset type: W3-M4 children's coding-game story background, wide landscape raster
Primary request: Create a polished bright 3D Chinese children's storybook game background for the Journey to the West mission 八戒归队. Match the visual quality, rounded forms, materials, lighting, and color richness of the approved W3 references, but create a new scene.
Scene/backdrop: Gao family manor's welcoming main courtyard and open reception hall in early warm morning light, after conflict has ended. Elegant tiled roofs, carved timber columns, subtle incense table and travel-ready open gate in the distance. No characters.
Composition/framing: wide 16:9 composition, clear uncluttered central and lower foreground stage for overlaid character sprites, architectural detail toward edges, gentle depth leading toward the westward gate.
Lighting/mood: sunny, hopeful, calm reconciliation, warm gold and jade-green accents.
Constraints: no people, no animals, no weapons, no ropes, no violence, no humiliation, no romantic or marriage imagery, no signs, no lettering, no symbols resembling text, no watermark, no UI. Do not copy the exact reference layout. Finished production illustration, not a placeholder.
Safety QA constraints: no text; no pseudo-text; no binding; no ear pulling; no attack; no adult marriage; no humiliating pose.
Processing: the accepted built-in PNG (`exec-4e4ab52f-64c6-4823-b1ee-fab2158f42ed.png`, 1672x941 RGB) was inspected at original resolution. Sharp only encoded it to 1672x941 WebP (`quality: 84`, `smartSubsample: true`) without crop, redraw, compositing, or content edits. Original-resolution QA found no characters, readable text, weapons, binding, attack, adult content, humiliation, clipping, or baked UI.
```

### Prompt W3M4-002 bajie joining states

```text
Use case: illustration-story
Asset type: transparent horizontal three-cell character state sheet for W3-M4 八戒归队
Primary request: Generate one production-ready panoramic sprite sheet with exactly three clearly separated equal-width story groups on a genuinely transparent background. Match the rounded, polished bright 3D Chinese children's storybook game character style and lighting of the approved W3 references. Keep character identities, clothing, scale, and proportions consistent across all three groups.
Panel 1, left: Pigsy before receiving the nickname 八戒, respectfully known as 猪悟能, calmly explaining Guanyin's prior guidance and vows to Tang Monk; Sun Wukong stands nearby peacefully. Open, sincere body language.
Panel 2, center: Tang Monk kindly gives the new nickname 八戒; Pigsy receives it respectfully and happily; Sun Wukong smiles as senior disciple. Gentle teacher-student moment.
Panel 3, right: the three pilgrims begin traveling west; Pigsy now carries the simple travel luggage pole responsibly, Tang Monk and Sun Wukong accompany him. Cheerful forward motion, no combat.
Composition/framing: exactly three non-overlapping groups, each fully contained inside its equal cell with generous transparent gutters, full bodies visible, no cropping, no background scenery.
Constraints: real transparent alpha; no written text, labels, calligraphy, symbols resembling text, speech bubbles, watermark, borders, panels, checkerboard; no ropes, bindings, ear-pulling, kneeling humiliation, attacks, raised weapons, romantic or marriage imagery, adult themes. Do not include Pigsy's rake. Do not reuse the exact poses from references.
Safety QA constraints: no text; no pseudo-text; no binding; no ear pulling; no attack; no adult marriage; no humiliating pose.
...
### Prompt W4M3-001 old-woman-visitor

```text
Use case: illustration-story
Asset type: W4-M3 transparent full-body story character for a children’s coding game
Primary request: 一位端庄慈祥的山中老妇，朴素整洁的中国传统衣着，站姿自然，双手完整可见，完整全身，适合 8–12 岁儿童。
Scene/backdrop: genuinely transparent RGBA background with no floor, scenery, colored backdrop, checkerboard, glow panel, or chroma key
Subject: exactly one elderly woman; dignified, kind, calm, naturally proportioned; modest tidy traditional clothing; both hands, both feet, and the entire silhouette visible
Style/medium: bright, warm, refined 3D Chinese mythology children’s storybook illustration
Composition/framing: square 1:1 transparent canvas; subject centered; generous true-alpha padding on all sides; no cropping; mobile-readable silhouette
Lighting/mood: soft daylight; warm, welcoming, child-safe
Text: none
Constraints: output must be actual transparent RGBA with transparent pixels around the complete subject; one character only; preserve clean soft edges and full-body readability
Avoid: text, pseudo-text, letters, Chinese characters, logo, watermark, UI, weapon, attack, injury, corpse, skeleton, horror transformation, evil caricature, frightening face, exaggerated aging, sexualization, child, old man, extra people, cropped hands, cropped feet, opaque or colored background
Processing: accepted OpenAI built-in image_gen result `.codex/generated_images/01a05a66-5dc3-7903-8e63-b5c478dcf85c/exec-11271c73-0f39-4c9c-8767-89297ceb3d2f.png` (1254x1254 RGBA) was inspected at original size. It contains one complete, friendly elderly visitor with visible hands and feet, no text, logo, watermark, weapon, attack, injury, corpse, skeleton, horror, or unsafe depiction, and genuine transparent pixels around the subject. The reproducible technical alpha matting decoded the source to raw RGBA, aligned every semi-transparent alpha-edge pixel's RGB to its nearest opaque neighbour within 2px, and made semi-transparent pixels without such a neighbour fully transparent. Sharp 0.35.3 then internally premultiplied alpha, proportionally resized the full 1254x1254 canvas to 880x880 with Lanczos3, and unpremultiplied it; the same nearest-opaque alpha-edge cleanup was repeated after resize. Alpha values greater than or equal to 96 became 255 and all others became zero, then 8-neighbor connected alpha islands smaller than 16 pixels were removed. Finally Sharp added exactly 72px of transparent padding on every side to produce the centered 1024x1024 canvas and encoded a lossless WebP. This changes only edge alpha/RGB, scale, and placement: opaque artwork is unchanged, with no crop, art redraw, compositing, chroma key, generative background removal, or subject edit. Shipping output is a 1024x1024 binary true-alpha WebP with 866,152 fully transparent pixels, 182,424 opaque pixels, zero partial-alpha pixels, alpha-edge mismatch 0%, zero low-alpha orphan pixels or long-line runs, and alpha>128 artwork padding left 357px, top 76px, right 350px, bottom 78px. The final file is 258,690 bytes with SHA-256 `b1cf7db437613bbfeb6cea555d7f9b9dca53b2cf27df8d81ccea19a0af601f91`, for `w4-m3 WeekFourBranchScene`. Original-size inspection over transparent and white preview backgrounds confirmed the full head, hands, clothing and feet remain intact without a coloured fringe. Fresh visual QA ran after the five-project W4-M3 matrix: roots `visual-results/week-four-python-branch-st-0c553-rt-parent-summary-and-W4-M4-{desktop-chromium-1440x1024,tablet-webkit-768x1024,mobile-chromium-390x844,desktop-firefox-1440x1024,narrow-chromium-320x844}/`, with `w4m3-default-<project>.png` and `w4m3-proven-<project>.png` in each root (10 screenshots total). Original-detail inspection confirmed the elderly visitor's full head, hands, clothing and feet at 1440, 768, 390 and 320 widths, no crop, coloured fringe, white box, hard edge, overlap or horizontal overflow, and consistent placement beside both same-appearance cards; this record is `visual-qa-passed`.
```

### Prompt W4M3-002 branch-route-states

```text
Use case: illustration-story
Asset type: W4-M3 transparent three-state horizontal sprite strip for a children’s coding game
Primary request: 明亮精致的 3D 中国儿童绘本风格分支路线状态图，准确表达三个连续状态。
Scene/backdrop: genuinely transparent RGBA background; no opaque panel, no colored fill, no checkerboard, no chroma key
Subject: one simple mountain two-way crossroads rendered in exactly three separate, equal-width, non-overlapping square cells. Cell 1: waiting at the two-way crossroads, neither route illuminated. Cell 2: both mutually exclusive routes illuminated at the same time, clearly communicating a route conflict. Cell 3: only one safe route illuminated, clearly communicating confirmed selection.
Style/medium: bright, refined 3D Chinese children’s storybook illustration; child-safe; clean mobile-readable silhouettes
Composition/framing: exact 3:1 transparent horizontal strip; three equal square cells from left to right; identical camera angle, scale, crossroads geometry, and visual treatment in all cells; clear cell boundaries through transparent gutters only; generous true-alpha padding inside every cell; no overlap or spill between cells; each square remains readable when cropped individually on mobile
Lighting/mood: warm clear daylight; calm, curious, non-frightening
Text: none
Constraints: output must be actual transparent RGBA with transparent pixels; exact 3:1 canvas; exactly three cells and no fourth panel; state differences only in route illumination; consistent camera and scale
Avoid: text, letters, Chinese characters, pseudo-text, code, answer labels, arrows made from text, emoji, logo, watermark, UI, people, characters, weapon, attack, injury, corpse, skeleton, horror, frightening face, opaque background, overlapping cells, inconsistent cameras, cropped routes
Processing: accepted OpenAI built-in image_gen result `.codex/generated_images/01a05a66-5dc3-7903-8e63-b5c478dcf85c/exec-3db5b776-fe8f-468b-a6fe-18639f813614.png` (2172x724 RGBA, exact 3:1) was inspected at original size. The three non-overlapping square cells keep the same camera, scale, crossroads geometry, and transparent gutters, with waiting, simultaneous-route conflict, and one-route confirmation readable without text. Sharp 0.35.3 only proportionally resized it to 1536x512 and encoded WebP (`quality: 78`, `alphaQuality: 90`, `effort: 6`, `smartSubsample: true`), preserving alpha without crop, redraw, compositing, chroma key, background removal, or content edit. Source and shipping cell boundaries remain exactly 0–511, 512–1023, and 1024–1535. Shipping output is 1536x512 true-alpha WebP with 263,693 fully transparent pixels, 184,348 bytes, SHA-256 `3bdf6244e763333295fcfd6de6e3a6799222bf05f26695a61dfe1126d88dd832`, for `w4-m3 WeekFourBranchScene`. Fresh visual QA ran after the five-project W4-M3 matrix: roots `visual-results/week-four-python-branch-st-0c553-rt-parent-summary-and-W4-M4-{desktop-chromium-1440x1024,tablet-webkit-768x1024,mobile-chromium-390x844,desktop-firefox-1440x1024,narrow-chromium-320x844}/`, with `w4m3-default-<project>.png` and `w4m3-proven-<project>.png` in each root (10 screenshots total). Original-detail inspection confirmed exactly one intended waiting/proven cell is visible per state with no cross-cell bleed, seam, white box, hard edge or background mismatch; camera, scale and crossroads geometry remain consistent, both same-appearance cards align with the visible state, and editor, feedback, safe epilogue and responsive layout remain readable without horizontal overflow. This record is `visual-qa-passed`.
```
...
### Prompt W5M4-001 contest-courtyard

```text
Create a finished background illustration for a children's Journey to the West coding game, W5-M4 story recording and problem decomposition. Bright premium 3D children's Chinese storybook style with softly rounded forms, warm golden daylight, jade green and teal roof tiles, rich crafted textures. Ancient Chechi palace courtyard seen from a shaded open scholar pavilion. Foreground low wooden reading desk to one side holding three closed plain stitched booklets and one open blank cream record book, a brush rest. Middle distance spacious pale stone courtyard, red pillars and elegant palace roofs, soft green trees, blue sky. Landscape 1536x1024, uncluttered open center, inviting calm composition, full bleed. This is a clearly symbolic educational recap setting, not a literal reenactment. No humans, animals, fighting, weapons, injuries, cauldrons, tall stacks of tables, religious statues, magic or success effects. No writing, letters, text, numbers, symbols, logos, watermark or UI. No diagrams, split panels, infographic.
```

Generated 2026-09-11 with built-in image_gen. Source `exec-bd38d9ce-d3b7-44a7-a31b-a688f9367c79.png` copied unchanged to `assets/source/visual/week-five-trials/contest-courtyard-background.png`, SHA-256 `7177ccb21921a3eaee0174bb224647a8fa86975bc5c60764fc11b592d0a1a6d6`. Existing Sharp 0.35.3 encoded WebP quality88 without resize, crop, redraw or compositing. Shipping dimensions 1536x1024 RGB, 311702 bytes. Original visually inspected: bright palace courtyard and blank teaching record books, no writing, injury, frightening imagery or baked-in success state. The pavilion is an explicitly symbolic teaching recap setting, not an invented canon event. Integrated Chromium default, first ownership failure, second missing-call failure, repeated-call failure, success, refresh and read-only real replay passed in dev StrictMode. Original-resolution desktop screenshots and 1440/768/390/320px completed-view screenshots were visually inspected in `artifacts/w5m4-independent/`; all viewports loaded the 1536x1024 art correctly, without horizontal page overflow or distorted art. Phone and tablet require vertical scrolling between records and code. This scoped visual inspection does not replace the five-project acceptance matrix.

### Prompt W5M3-001 rain-altar

```text
Use case: illustration-story. Asset type: finished background illustration for a children's Journey to the West coding lesson W5-M3, weather-order parameter learning. Primary request: ancient Chinese Chechi kingdom outdoor rain-prayer altar courtyard, a broad low pale stone ceremonial platform and steps in the middle distance, elegant red-pillared palace roofs with jade green glazed tiles at both sides, stone balustrades, pines, hazy mountains far beyond, sweeping softly clouded blue sky with warm daylight. Bright premium 3D children's storybook illustration with softly rounded modeled forms, rich tactile roof tiles, warm golden light and teal accents, inviting and safe, consistent with a cheerful educational adventure. Wide landscape 1536x1024, eye-level gentle perspective, beautifully composed uncluttered foreground stone courtyard, ample open center and visible sky. The setting is neutral before the weather commands: no visible rain, no lightning, no magical effects implying success. No humans or animals, no religious statues, no text or inscriptions, no UI, no diagrams, no lettering, no logos, no watermark. Do not make an infographic or split panel. Full bleed polished illustration. Art direction reference tag: bright-3d-storybook-chechi-rain-altar.
```

Generated 2026-09-11 with built-in image_gen. Original PNG copied unchanged from `exec-44e4d711-9810-4700-ab4a-9031128cb6ff.png` to `assets/source/visual/week-five-weather/rain-altar-background.png` (SHA-256 `e609007b9dd1ddae61818324132b346cccc26aba1e6263747dd8e369a8ff69c7`). Existing Sharp 0.35.3 performed format-only WebP encoding at quality88, with no resize, crop, redraw or compositing. Shipping image is 1536x1024 RGB, 271088 bytes. Original was visually inspected for a readable bright courtyard composition, no writing or UI, no frightening weather, and no success state baked into the art. Integrated Chromium default/failure/success, refresh and readonly replay passed in dev StrictMode; 1440/768/390/320px completed-view screenshots were inspected in `artifacts/w5m3-independent/`. The image remains legible, fully loaded at 1536x1024, correctly proportioned and unclipped; every viewport has no horizontal page overflow. Narrow layouts require vertical scrolling. This asset visual inspection is distinct from full five-project browser acceptance.

### Prompt W5M1-001 chechi-rescue

```text
Create a finished game background illustration, landscape 1536x1024. Bright polished 3D children's Chinese Journey to the West storybook style, warm cream sunlight, jade green hills and terracotta Chinese city gate of Chechi kingdom in distance. In foreground a friendly young Monkey King in yellow tunic gestures helpfully beside exactly three friendly adult Buddhist monks in simple gray/brown robes standing on a safe open stone path. A small wooden handcart is parked harmlessly to the side, nobody tied up, no chains, no injury, no weapons action. Compassionate and hopeful expressions. Rounded shapes, richly crafted materials, attractive professional children's game art. Clear silhouettes, spacious composition, camera medium-wide eye level. No writing, text, labels, numbers, frames, logos or UI. This image supplies story setting only; gameplay state will be in separate UI.
```

Generated 2026-09-11 with built-in image_gen; source PNG `exec-aa204849-988d-4ce0-ae94-a70c2051ced8.png`. Format-only conversion to WebP quality86 using existing sharp; no redraw or compositing. Original and integrated desktop default/failure/completion inspected; five-project viewport results are recorded in docs/verification/week-five-monks-loop.md.

### Prompt W6M1-001 flaming mountain background

```text
Create one finished raster environment illustration for a Chinese children’s Journey to the West educational programming game, landscape 1536x1024. Bright polished soft 3D storybook illustration, rounded tactile forms, warm sunlight, jade-teal shadows and orange sandstone, inviting child-safe mood. Scene: a safe shaded roadside learning pavilion in foreground looking toward distant Flaming Mountains, layered red-orange rounded mountain ridges with small stylized distant flame glows, blue sky and airy clouds. On right a small friendly Sun Wukong in yellow tunic and red scarf stands at a plain wooden study table with three blank simple paper record sheets and a writing brush, curious thoughtful expression. Wukong never holding or using fan, no battle or injuries. Left and center remain visually calm for composition. No text, no letters, no numbers, no UI, no labels, no logos, no panels. The art is a static story setting and must not depict a solved puzzle or extinguished fire. High quality finished game background consistent with an existing cheerful 3D Chinese fantasy storybook style.
```

2026-09-12 built-in image_gen output `exec-365aefa8-2908-42a4-93eb-51f8eb8b743b.png`; original retained under the Codex generated_images task directory. Technical packaging only: Sharp WebP encoding, quality 78, effort 6, original 1536x1024 dimensions; no redrawing. Original inspected: clear three blank sheets, friendly Wukong, distant flames, no text, injury or implied solved output. Integrated desktop 1440x1024 and narrow 320x844 default/failure/completed views inspected by the primary agent: composition remains clear, no fabricated output or placeholder illustration, no page overflow. Screenshots: artifacts/w6m1-independent/{desktop,narrow}-{default,failure,complete}.png. Final five-project functional/browser results are tracked in docs/verification/week-six-structured-records.md; this asset-slot approval does not claim whole-level acceptance.

### W6-M2 shared asset slot verification (2026-09-12)

The existing W6M1-001 raster is reused unchanged in `WeekSixClassificationScene`, `WeekSixPromptScene`, and `WeekSixFactCheckScene` as the story setting for the child's read-only source material. Purpose, generation prompt, dimensions, hash and provenance remain the registered original. No generated labels or solved outcome are baked into the scene. The primary agent inspected the original image and the integrated desktop / 320px scene and classification layout after correcting clipped evidence text; evidence is under `artifacts/w6m2-independent/` (`desktop-layout.png`, `narrow-layout.png`, and `*-classification-viewport.png`). The M1, M2, M3 and M4 source slots are enforced by the asset inventory contract, including rejection of a missing slot or an unapproved image reference. These development images establish asset-slot QA only; final production browser evidence is recorded in each mission acceptance report.
